...
MODEL = "/home/muhdirfanrosdin/resAI/MCTA4363-Resilient-AI/models/gemma4-E4B-hybrid.gguf"
...
print("\n--- EXPERIMENT 007: Hybrid Q8_vision+Q4_language (llama.cpp) ---")
...
report = {
    "model": "gemma-4-E4B-it Hybrid Q8_vision+Q4_language",
...
with open("007_results.json", "w") as f:
...
print(f"{'='*45}")
print("Saved to 007_results.json")